...
- **Stocknized Agent on Clawpump** — Three agent tokens launched through Clawpump's API (scSPCX/SPCX, scSNDK/SNDK, BonkClaw/CLAW), run by the Clawpump agent Solent, whose wallet is SAID-verified on-chain (597yKNtaZBasmu61ootY5pBWHfktKXzFP38fB7K3A6g6); two, each paired with a Backpack/Sunrise stock and pooled on Meteora: scSPCX/SPCX (SpaceX, Sunrise's flagship) and scSNDK/SNDK. https://solscan.io/account/GYN1e3YjRrWuAZDVJthgW1wYJBPaciZxmW1gfDRaFkHP
