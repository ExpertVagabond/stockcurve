...
- **Stocknized Agent on Clawpump** — Two agent tokens launched through Clawpump's API, each paired with a Backpack/Sunrise stock and pooled on Meteora: scSPCX/SPCX (SpaceX, Sunrise's flagship) and scSNDK/SNDK. https://solscan.io/account/GYN1e3YjRrWuAZDVJthgW1wYJBPaciZxmW1gfDRaFkHP
